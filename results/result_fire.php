...
<body>
    <div class="container-result" id="result-page">
        <div class="result-element" style="background-color: white;" id="element-fire">
            <div class="share-img">
                <img src="../images/fire_result.jpg">
            </div>
            ...
            <p class="element-title float-animation-fire">
            ...
            <p class="element-description">
                You are the flame that never dies. Everyone around you can't help but attracted to your passion and energy. Maybe not obvious to others, but deep down you are someone who refuses to follow rules.
            </p>
        </div>

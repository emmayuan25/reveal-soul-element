...
<body>
    <div class="container-result">
        <div class="result-element" style="background-color: white;" id="element-light">
            <div class="share-img">
                <img src="../images/light_result.jpg">
            </div>
            <div class="result-welcome">
                <span id="username_" style="font-weight: bold;"></span> 's soul element is the
            </div>

            <p class="element-title float-animation-light">
                Light
            </p>
            <p class="element-quote">
                "In this world, no one can make you fall if your own faith is still standing."  - Martin Luther King
            </p>
            <p class="element-description">
                Your soul is composed of light. You believe in the world's greater good and use your leadership as the guiding light. You are optimistic and positive. You are willing to take risks and sacrifice for a brighter future.
            </p>
        </div>

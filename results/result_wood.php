...
<body>
    <div class="container-result">
        <div class="result-element" style="background-color: white;" id="element-wood">
            <div class="share-img">
                <img src="../images/wood_result.jpg">
            </div>
            <div class="result-welcome">
                <span id="username_" style="font-weight: bold;"></span> 's soul element is the
            </div>

            <p class="element-title float-animation-wood">
                Dendro
            </p>
            <p class="element-quote">
                "As long as people do not lose their direction, they will not lose their own." Plato
            </p>
            <p class="element-description">
                Your soul is composed of rock. You are faithful to your heart and seldom change because of others' opinions. You'd like things perfect, and you would work until it reaches your standards.
            </p>
        </div>

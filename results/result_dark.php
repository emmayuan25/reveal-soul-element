...
<body>
    <div class="container-result">
        <div class="result-element" style="background-color: white;" id="element-dark">
            ...
            <p class="element-title float-animation-dark">
                Darkness
            </p>
            ...
            <p class="element-description">
                You are curious aobut this world. Many people may think you are hard to figure out, but you merges into the crowds pretty well. Compared to a front-line soilder, you prefer to be the one overseeing the chessboard. You attract people similar to you.
            </p>
        </div>

...
<body>
    <div class="container-result">
        <div class="result-element" style="background-color: white;" id="element-mist">
            <div class="share-img">
                <img src="../images/mist_result.jpg">
            </div>
            <div class="result-welcome">
                <span id="username_" style="font-weight: bold;"></span> 's soul element is the
            </div>

            <p class="element-title float-animation-mist">
                Mist
            </p>
            <p class="element-quote">
                "Labelled a delinquent. That's the only kind of label I want to be crucified under." Osamu Dazai
            </p>
            <p class="element-description">
                Your soul is composed of mystical fog, ethereal like wind and rippled like water. You have some unrealistic ambition, but everything you ended up doing were beautifully done.
            </p>
        </div>

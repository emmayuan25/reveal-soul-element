...
<body>
    <div class="container-result">
        <div class="result-element" style="background-color: white;" id="element-rock">
            <div class="share-img">
                <img src="../images/rock_result.jpg">
            </div>
            <div class="result-welcome">
                <span id="username_" style="font-weight: bold;"></span> 's soul element is the
            </div>

            <p class="element-title float-animation-rock">
                Geo
            </p>
            ...
            <p class="element-description">
                Your soul is composed of rock. You are the setting stone of your group, being the responsible and helpful one. You favor people that are humble and speak with facts. Your patience and methodical way of thinking makes your work efficient.
            </p>
        </div>
